...
class cls_wmpOauth extends cls_wmpBasic{
    ...
    function getACToken($code){
    	if($this->accessToken == null){
    		...
    		//$accessInfo = $this->getResource($url);
			$accessInfo = cls_w08Basic::getResource($url,3);
    ...
    function getUserInfo($actoken, $openid) {
		...
		return cls_w08Basic::jsonDecode($data,$this->acuinfoUrl);
    }
