...
if($curuser->info['mchid'] == 3){//属于经纪公司
	//$caid = 554; //找到栏目ID
}else{
	//$caid = 512;
}
...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('valid',array('title'=>'上架'));
...
//	$oL->m_additem('createdate',array('type'=>'date',));
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?action=designNews_a&aid={aid}",'width'=>40,));
