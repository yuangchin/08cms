<?PHP
$chid = empty($chid) ? 9 : $chid; //指定chid
if(!in_array($chid,array(9,10))) cls_message::show('参数错误！'); 
...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?action=xuqiuarchive&aid={aid}",'width'=>40,));
