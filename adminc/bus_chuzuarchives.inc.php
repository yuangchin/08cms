...
if(!submitcheck('bsubmit')){
	...
	$oL->m_header((empty($mname) ? '' : $namearr[$mname]." - ")."出租房源管理");
    ...
    $oL->m_additem('zj',array('title'=>'价格',));
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?action=bus_chuzuadd&aid={aid}&chid=$chid&ispid4=$ispid4",'width'=>40,));
