...
if(!submitcheck('bsubmit')){
	...
	//内容列表区 **************************
	$oL->m_header(" &nbsp;<a style=\"color:#C00\" href=\"?action=huxingadd&pid=$pid\" onclick=\"return floatwin('open_arcexit',this)\">>>添加户型</a>",1);
	$oL->m_additem('selectid');
	$oL->m_additem('subject',array('len' => 20));
	$oL->m_additem('thumb',array('type'=>'image','width'=>'100%','height'=>180));
	$oL->m_additem('editself',array('title'=>'编辑','mtitle'=>'[编辑]','url'=>"?action=huxingadd&aid={aid}",'width'=>40));
