...
define('IN_UC', TRUE);
defined('UC_CLIENT_VERSION') || define('UC_CLIENT_VERSION', '1.6.0');
defined('UC_CLIENT_RELEASE') || define('UC_CLIENT_RELEASE', '20110501');
define('UC_ROOT', substr(__FILE__, 0, -10));
defined('UC_DATADIR') || define('UC_DATADIR', UC_ROOT.'./data/');
...
function uc_api_mysql($model, $action, $args=array()) {
	...
	if(empty($uc_controls[$model])) {
        ...
        _08_FilesystemFile::filterFileParam($model);
