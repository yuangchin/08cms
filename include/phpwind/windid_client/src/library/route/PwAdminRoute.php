 ...
 * @version $Id: PwAdminRoute.php 24507 2013-01-31 06:36:19Z long.shi $
 * @package library
 */
class PwAdminRoute extends AbstractWindRoute {
	...
	protected function init() {
		...
		$this->default_m = Wind::getApp()->getConfig('default-module', '', $router->getDefaultModule());
		$this->init = true;
	}
