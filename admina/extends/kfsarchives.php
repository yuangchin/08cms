...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('ccid1');
	$oL->m_additem('ucount',array('type'=>'ucount','title'=> '开发楼盘','url'=>'?entry=extend&extend=kfsloupans&pid={aid}','func'=>'gethjnum','arid'=>'6','chid'=>'4','width'=>60,));	
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=kfsadd&aid={aid}",'width'=>40,));
