...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('valid');
	$oL->m_additem('clicks',array('type'=>'input','title'=>'点击数','width'=>50,'w' => 3,'view'=>'H'));
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=designNews_a&aid={aid}",'width'=>40,));
