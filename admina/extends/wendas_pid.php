...
if(!submitcheck('bsubmit')){
	...
	//内容列表区 **************************
	$oL->m_header(" &nbsp;<a style=\"color:#C00\" href=\"?entry=extend&extend=wendas_load&pid=$pid\" onclick=\"return floatwin('open_arcexit',this)\">>>加载问答</a> &nbsp;<a style=\"color:#C00\" href=\"?entry=extend&extend=qa_a&pid=$pid\" onclick=\"return floatwin('open_arcexit',this)\">>>添加问答</a>",1);
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=qa_a&aid={aid}",'width'=>40,));
	...
	$oL->o_footer('bsubmit');
	$oL->guide_bm('&nbsp;&nbsp;&nbsp;1.合辑管理>>清除，该操作是把数据在本页面列表中删除，可以通过"加载问答"操作加载进来。<br/>&nbsp;<br/>','1');
