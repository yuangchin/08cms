...
//搜索项目 ****************************
//s_additem($key,$cfg)
$oL->s_additem('keyword',array('fields' => array('a.aid' => '户型ID','a.subject' => '户型编号','b.aid' => '楼盘ID','b.subject' => '楼盘名称','a.mname'=>'会员账号'),));//fields留空则默认为array('a.subject' => '标题','a.mname' => '会员','a.aid' => '文档ID')
...
if(!submitcheck('bsubmit')){
	...
	//显示列表区头部 ***************
	$oL->m_header("户型&nbsp;&nbsp;内容管理&nbsp;&nbsp;&nbsp;<input class='checkbox' type='checkbox' onclick='chooseall(this)' value=''>全选");
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'[详情]','color'=>'red','url'=>"?entry=extend&extend=huxingarchive&aid={aid}",'width'=>40,));
	$oL->m_mcols_style("{thumb}<div style=\"clear:both;\"></div>{selectid} {subject} &nbsp;审核({checked}) &nbsp;{detail}<br/>[{ccid1}]{lpname}<br>");
