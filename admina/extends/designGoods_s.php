...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('valid');
	$oL->m_additem('clicks',array('title'=>'点击数','width'=>50,'w' => 3,));
	foreach($oL->A['coids'] as $k){
		$oL->m_additem("ccid$k");
	}	
	$oL->m_additem('anlinum',array('type' => 'url','title'=>'订单','mtitle'=>'[{anlinum}]','url'=>"?entry=extend&extend=commu_brandbuy&aid={aid}",'width'=>50,'w' => 3,));
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=designGoods_a&aid={aid}",'width'=>40,));
