...
//搜索项目 ****************************
$oL->s_additem('keyword',array('fields' => array('a.subject' => '标题','a.mname' => '会员','a.aid' => '文档ID'),));
...
if(!submitcheck('bsubmit')){
	...
	//内容列表区 **************************
	$oL->m_header(" &nbsp; <a style=\"color:#C00\" href=\"?entry=extend&extend=zt_load&pid=$pid&chid=$chid\" onclick=\"return floatwin('open_arcexit',this)\">>>加载内容</a>",1);
	...
	//$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'管理','url'=>"?entry=extend&extend=zixunadd&aid={aid}&chid={chid}",'width'=>40,));
