...
if($caid==26) $oL->s_additem('ccid45');
...
if(!submitcheck('bsubmit')){
	...
	foreach($oL->A['coids'] as $k){
		if($caid==26 && $k==45){ $oL->m_additem("ccid$k",array('view'=>'S',)); }
		elseif($caid!=26 && $k==45){ continue; }
		else{ $oL->m_additem("ccid$k",array('view'=>'')); }
