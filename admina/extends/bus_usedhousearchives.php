...
$chid = $caid==617 ? 118 : 117; //echo "$caid,$chid";
#-----------------
...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=bus_usedhousearchive&aid={aid}&caid={caid}",'width'=>40,));
