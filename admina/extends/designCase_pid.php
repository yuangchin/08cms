...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=designCase_a&aid={aid}",'width'=>40,));
	...
	$oL->o_footer('bsubmit');
	$oL->guide_bm('&nbsp;&nbsp;&nbsp;1.合辑管理>>清除，该操作是把数据在本页面列表中删除，可以通过"加载案例"操作加载进来。<br/>&nbsp;<br/>','1');
