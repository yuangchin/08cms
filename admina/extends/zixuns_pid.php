...
if(!submitcheck('bsubmit')){
	...
	//内容列表区 **************************
	$oL->m_header(" &nbsp;<a style=\"color:#C00\" href=\"?entry=extend&extend=zixuns_load&pid=$pid\" onclick=\"return floatwin('open_arcexit',this)\">>>加载资讯</a> &nbsp;<a style=\"color:#C00\" href=\"?entry=extend&extend=zixunadd&pid=$pid\" onclick=\"return floatwin('open_arcexit',this)\">>>添加资讯</a>",1);
	...
	//显示单选项
	$oL->o_view_bools('合辑管理 ',array('inclear'));
	$oL->o_view_bools();
	...
	$oL->o_footer('bsubmit');
	$oL->guide_bm('&nbsp;&nbsp;&nbsp;1.合辑管理>>清除，该操作是把数据在本页面列表中删除，可以通过“加载资讯“操作加载进来。<br/>&nbsp;<br/>','1');
