...
if(!submitcheck('bsubmit')){
	...
	$oA->fm_fields(array('subject','keywords','abstract','content','createdate','clicks'),0);
	//排除'createdate','clicks'后的剩余字段
	$oA->fm_fields(array('createdate','clicks'),1);
	$oA->fm_fields(array('createdate','clicks'),0);
	...
	$oA->fm_params(array('createdate','clicks'));
	...
	*/
	...
	$oA->sv_params(array('createdate','clicks'));
