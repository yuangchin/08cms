...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('ahds',array('type'=>'ucount','title'=>'团购','url'=>"?entry=extend&extend=huodongs_pid&pid={aid}",'func'=>'gethjnum','arid'=>'3','chid'=>5,'width'=>28,));
	...
	$oL->m_additem('ayss',array('type'=>'url','title'=>'意向','mtitle'=>'[{ayss}]','url'=>"?entry=extend&extend=yixiangs&aid={aid}",'width'=>28,));	
	$oL->m_additem('liuyan',array('type'=>'ucount','title'=>'评论','url'=>"?entry=extend&extend=comments&aid={aid}&chid=4",'func'=>'getjhnum','cuid'=>'1','chid'=>4,'width'=>28,));	
	$oL->m_additem('awds',array('type'=>'url','title'=>'问答','mtitle'=>'[{awds}]','url'=>"?entry=extend&extend=wendas_pid&pid={aid}",'width'=>28,));
	$oL->m_additem('atjs',array('type'=>'ucount','title'=>'特价房','url'=>"?entry=extend&extend=tejias_pid&pid={aid}",'func'=>'gethjnum','arid'=>'1','chid'=>107,'width'=>40,));
	...
	$oL->m_additem('adps',array('type'=>'url','title'=>'评分','mtitle'=>'查看','url'=>"?entry=extend&extend=lp_pingfen&aid={aid}",'width'=>28,));
	...
	$oL->m_additem('detail',array('type'=>'url','mtitle'=>'详情','url'=>"?entry=extend&extend=loupanadd&aid={aid}",'width'=>60));
