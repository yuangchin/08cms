...
/* 参数初始化代码 */
$mchid = 13;//empty($mchid) ? 0 : max(0,intval($mchid));//可手动指定，不接收外部参数
$_init = array(
...
//搜索项目 ****************************
$oL->s_additem('keyword',array('fields' => array('m.mname' => '会员帐号','m.mid' => '会员ID','s.lxdh' => '联系电话'),));//fields留空则默认为array('m.mname' => '会员帐号','m.mid' => '会员ID')
...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('xingming',array('len' => 32,'field' => 'xingming','title' => '公司名称')); //subject
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=membersales2&mid={mid}",'width'=>40,));
