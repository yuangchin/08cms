...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('xingming',array('title'=>'姓名','width'=>40,));
	$oL->m_additem('mchid',array('title'=>'会员类型','width'=>80,)); 
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=bus_chuzuarchive&aid={aid}&caid={caid}",'width'=>40,));
