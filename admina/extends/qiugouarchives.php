...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('zj',array('type'=>'other','title'=>'价格','mtitle'=>'{zj}万元'));
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=qiugouarchive&aid={aid}",'width'=>40,));
