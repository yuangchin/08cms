...
if(!submitcheck('bsubmit')){
	...
	//内容列表区 **************************
	$hlinks = " &nbsp; <a style=\"color:#C00\" href=\"?entry=extend&extend=huxingarchive&pid=$pid&arid=$arid\" onclick=\"return floatwin('open_arcexit',this)\">&gt;&gt;添加户型</a>";
	$hlinks .= " &nbsp; <a style=\"color:#C00\" href=\"?entry=extend&extend=huxingarchives&isframe=1\" target='_blank'>&gt;&gt;所有户型</a>";
	...
	$oL->o_footer('bsubmit');
    $oL->guide_bm('&nbsp;&nbsp;&nbsp;1.操作项目>>删除，该操作是把数据在本页面列表中删除，同时也在户型管理列表中把该户型删除。<br/>&nbsp;<br/>','1');
