...
if(!submitcheck('bsubmit')){
	...
	//内容列表区 **************************
	$oL->m_header(" &nbsp;<a style=\"color:#C00\" href=\"?entry=extend&extend=loupans_load&pid=$pid\" onclick=\"return floatwin('open_arcexit',this)\">>>加载楼盘</a> &nbsp;",1);	
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=loupanadd&aid={aid}",'width'=>40,));
	...
	$oL->o_footer('bsubmit');
	$oL->guide_bm('&nbsp;&nbsp;&nbsp;1.合辑管理>>清除，该操作是把数据在本页面列表中删除，可以通过"加载楼盘"操作加载进来。<br/>&nbsp;<br/>','1');
