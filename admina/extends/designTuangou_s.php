...
if(!submitcheck('bsubmit')){
	...
	$oL->m_additem('anlinum',array('type'=>'url','title'=>'报名','mtitle'=>'[{anlinum}]','url'=>'?entry=extend&extend=commu_huodongbm&aid={aid}'));
	$oL->m_additem('baoming',array('type'=>'url','mtitle'=>'添加','url'=>'etools/tuangou.php?aid={aid}'));
	$oL->m_addgroup('{anlinum}&nbsp;{baoming}','报名');
	...
	$oL->m_additem('detail',array('type'=>'url','title'=>'编辑','mtitle'=>'详情','url'=>"?entry=extend&extend=designTuangou_a&aid={aid}",'width'=>40,));
